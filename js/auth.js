...
function showUpgradeModal() {
  ...
  m.innerHTML = `
    <div class="modal-card" style="text-align:center;max-width:400px;">
      ...
      <p style="font-size:13px;color:var(--txd);margin-bottom:20px;line-height:1.6;" data-en="AI analysis, reports, estimates, social posts, and more." data-he="ניתוח AI, דוחות, הערכות עלויות, פוסטים ועוד.">AI analysis, reports, estimates, social posts, and more.</p>
      <div style="text-align:left;font-size:13px;color:var(--txd);margin-bottom:20px;line-height:2;">
